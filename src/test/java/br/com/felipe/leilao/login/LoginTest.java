...
public class LoginTest {
	...
	public void naoEfetuarLoginComDadosInvalidos() {
		...
		browser.findElement(By.id("username")).sendKeys("felipe");
		...
		Assert.assertThrows(NoSuchElementException.class, () -> browser.findElement(By.id("usuario-logado")).getText()); //verifica se está vindo vazio
